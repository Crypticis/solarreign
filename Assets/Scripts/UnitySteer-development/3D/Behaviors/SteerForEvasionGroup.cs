...
namespace UnitySteer.Behaviors
{
    ...
    /// </remarks>
    [AddComponentMenu("UnitySteer/Steer/... for Evasion Group")]
    public class SteerForEvasionGroup : Steering
    {
        #region Private fields

        private float _sqrSafetyDistance;

        [SerializeField] private GameObject[] menaces;
        ...
        {
            menaces = GameObject.FindGameObjectsWithTag("Enemy");
            base.Start();
            _sqrSafetyDistance = _safetyDistance * _safetyDistance;
        }
        ...
        protected override Vector3 CalculateForce()
        {
            ...
            {
                Vehicle _menace = menace.GetComponent<AutonomousVehicle>();
