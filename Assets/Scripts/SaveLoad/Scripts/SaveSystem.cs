...
public static class SaveSystem {
    ...
    public static void Save(string saveString) {
        ...
        int saveNumber = 1;
        while (File.Exists(SAVE_FOLDER + GameManager.instance.playerInfo.Name + "_" + saveNumber + "." + SAVE_EXTENSION)) {
            saveNumber++;
        }
        // saveNumber is unique
        File.WriteAllText(SAVE_FOLDER + GameManager.instance.playerInfo.Name + "_" + saveNumber + "." + SAVE_EXTENSION, saveString);
    }
