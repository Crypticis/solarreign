...
public class AAHardpoint : AALauncher
{
    ...
    public override void Launch(Transform target, Vector3 velocity)
    {
        ...
        if (launchingStation != null)
        {
            ...
            if (launchSuccessful)
            {
                ...
                if (isPlayer)
                    ScreenShake.instance.TriggerShake(.25f, .5f);
    ...
    private void InitializeStations()
    {
        ...
        {
            HardpointStation newStation = new HardpointStation(fireDelay, missilePrefabToLaunch, point, ownShip, bonusDamage);
    ...
    internal class HardpointStation
    {
        ...
        public HardpointStation(float reloadTime, AAMissile missilePrefab, Transform launchPoint, Transform ownShip, float damageBonus)
        {
