...
namespace GNB
{
    public class Bullet : MonoBehaviour
    {
        //
        [Header("Damage")]
        [Tooltip("Damage dealt to the object when the bullet hits something;.")]
        ...
        private void HandleImpactDamage(RaycastHit hitInfo)
        {
            ...
            {
                hitInfo.collider.GetComponent<DamageHandler>().TakeDamage(bulletDamage, shooter, this.gameObject);
            }
        }
