...
namespace GNB
{
    ...
    public class Gun : MonoBehaviour
    {
        ...
        /*[SerializeField] private*/ public List<Transform> FirePoints = new List<Transform>();
        ...
        private void Update()
        {
            ...
            if(soundType == SoundType.continous)
            {
                if(IsFiring == false && audioSource.isPlaying)
                {
                    audioSource.Stop();
                }
            }
        ...
        private void GetInheritedVelocity()
        {
