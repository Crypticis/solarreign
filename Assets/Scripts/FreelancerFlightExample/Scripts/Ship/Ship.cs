...
namespace FLFlight
{
    ...
    public class Ship : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            Physics.SetPhysicsInput(new Vector3(Input.Strafe * strafeMultiplier, 0.0f, Input.Throttle), new Vector3(Input.Pitch, Input.Yaw, Input.Roll));
            ...
            // player.isGrounded = true;  --- set controls similar to player. Use player ground detection. Use space for up, crtl for down. Able to land.
