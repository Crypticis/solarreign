...
namespace FLFlight
{
    ...
    public class ShipInput : MonoBehaviour
    {
        ...
        /*[SerializeField] private*/ public float rollSensitivity = 1f;
        ...
        private void SetStickCommandsUsingAutopilot()
        {
            ...
            //Added camera controll changes
            if (usingOrbit)
            {
                gotoPos = Camera.main.ViewportToWorldPoint(new Vector3(0.5f, 0.5f, mousePos.z));
            }
            else
            {
